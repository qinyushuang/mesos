...
class ReserveTest : public MesosTest {};


// TODO(mpark): Add tests for ACLs once they are introduced.


// This tests that an operator can reserve available resources.
TEST_F(ReserveTest, ReserveAvailableResources)
{
...
// outstanding offers.
TEST_F(ReserveTest, ReserveOfferedResources)
{
  TestAllocator<> allocator;
...
TEST_F(ReserveTest, ReserveAvailableAndOfferedResources)
{
  TestAllocator<> allocator;
...
// This tests that an attempt to reserve more resources than available
// results in a 'PreconditionFailed' HTTP error.
TEST_F(ReserveTest, InsufficientResources)
{
  TestAllocator<> allocator;
  ...
  AWAIT_READY(response);
  AWAIT_EXPECT_RESPONSE_STATUS_EQ(PreconditionFailed().status, response);
...
TEST_F(ReserveTest, BadCredentials)
{
  TestAllocator<> allocator;
...
TEST_F(ReserveTest, NoResources)
{
  TestAllocator<> allocator;
...
TEST_F(ReserveTest, NonMatchingPrincipal)
{
  TestAllocator<> allocator;
